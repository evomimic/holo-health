...
For the initial Proof-of-Concept (PoC), a very simplistic concept of HealthCard will be used. The DNA for this Personal Health Vault app will offer a single _Health Observation_ zome as shown in Figure 2.
...
* `subjectHash` refers to the subject of the observation
* `observerHash` refers to the agent that made the observation
